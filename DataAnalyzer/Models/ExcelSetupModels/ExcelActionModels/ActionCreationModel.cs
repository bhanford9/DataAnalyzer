...
{
  public abstract class ActionCreationModel : BasePropertyChanged, IActionCreationModel
  {
    // need one of these for each Tab... may want to abstract into different models? May be easier to just have them all in here though
