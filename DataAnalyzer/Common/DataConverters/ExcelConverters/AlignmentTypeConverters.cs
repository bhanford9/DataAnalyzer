...
namespace DataAnalyzer.Common.DataConverters.ExcelConverters
{
    ...
    {
        public static HorizontalAlignment ToLocalHorizontalAlignment(ExcelService.Styles.Alignments.HorizontalAlignment horizontalAlignment) => horizontalAlignment switch
        {
        ...
        public static ExcelService.Styles.Alignments.HorizontalAlignment ToExcelHorizontalAlignment(HorizontalAlignment horizontalAlignment) => horizontalAlignment switch
        {
        ...
        public static VerticalAlignment ToLocalVerticalAlignment(ExcelService.Styles.Alignments.VerticalAlignment verticalAlignment) => verticalAlignment switch
        {
        ...
        public static ExcelService.Styles.Alignments.VerticalAlignment ToExcelVerticalAlignment(VerticalAlignment verticalAlignment) => verticalAlignment switch
        {
