...
namespace DataAnalyzer.Common.DataConverters.ExcelConverters
{
    ...
    {
        public static BorderStyle ToLocalBorderStyle(ExcelService.Styles.Borders.BorderStyle borderStyle) => borderStyle switch
        {
        ...
        public static ExcelService.Styles.Borders.BorderStyle ToExcelBorderStyle(BorderStyle borderStyle) => borderStyle switch
        {
